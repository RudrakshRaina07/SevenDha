...
function Hero() {
    return ( 
        <div className='container mb-5'>
            <div className='row text-center mt-5 p-3 p-md-5 mb-5'>
                <h1 className='fs-3'>Charges</h1>
                <p className='text-muted fs-5 mt-2'>List of all charges and taxes</p>
           </div>
                <div className='row mt-3 mt-md-5 text-center p-3 p-md-5'>
                    <div className='col-12 col-md-4 mb-4 mb-md-0'>
                        <img src='media/pricingEquity.svg' className='img-fluid' style={{width:"70%"}}/>
                        <h3>Free equity delivery</h3>
                        <p className='text-muted mt-3'>All equity delivery investments (NSE, BSE), are absolutely free — ₹ 0 brokerage.</p>
                    </div>
                    <div className='col-12 col-md-4 mb-4 mb-md-0'>
                        <img src='media/intradayTrades.svg' className='img-fluid' style={{width:"70%"}}/>
