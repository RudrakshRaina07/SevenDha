    ...
    return ( 
        <div className='container'>
            <div className='row text-center p-5 mt-5 mb-5'>
                <h1 className='fs-4'>We pioneered the discount broking model in India.<br/>Now, we are breaking ground with our technology.</h1>
            </div>
            <div className='row p-5 mt-5 mb-5 border-top text-muted' style={{fontSize:"1rem", lineHeight:"1.8rem"}}>
